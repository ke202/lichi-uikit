...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#323531", backgroundDisabled: "#323531", contrast: "#323531", invertedContrast: "#1d24b1", input: "#3c3e3b", tertiary: "#65765f", text: "#ffffff", textDisabled: "#65765f", textSubtle: "#FFFFFF", borderColor: "#70a613", card: "#252d28", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#6ca013", background: "#323531", backgroundDisabled: "#323531", contrast: "#323531", invertedContrast: "#1d24b1", input: "#3c3e3b", primaryDark: "#0098A1", tertiary: "#65765f", text: "#FFFFFF", textDisabled: "#65765f", textSubtle: "#FFFFFF", borderColor: "#70a613", card: "#252d28", gradients: {
